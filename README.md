...
<!-- The image below is generated by .github/assets/gen_tree_svg.py — edit the
     LINES table there and re-run it when the structure changes. -->

<div align="center">
<img width="775" alt="File structure — init.lua, the lockfile and snippets/ at the root; lua/config/ with options, keymaps, autocmd and commands; lua/plugins/ with one module per area" src=".github/assets/structure.svg" />
</div>

<details>
<summary><b>Plain-text version</b> — copy-friendly</summary>
